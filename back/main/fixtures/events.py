    ...
    event_templates = [
        {
            ...
            "short_descriptions": ["Отмечаем день рождения на свежем воздухе", "Празднуем вместе", "Веселое торжество", "День рождения с друзьями"],
            "descriptions": [
        ...
        },
        {
            ...
            "short_descriptions": ["Конференция для разработчиков", "IT-мероприятие", "Технический форум", "Конференция по программированию"],
            "descriptions": [
        ...
        },
        {
            ...
            "short_descriptions": ["Учимся готовить", "Кулинарные уроки", "Мастер-класс от шеф-повара", "Изучаем кухню"],
            "descriptions": [
        ...
        },
        {
            ...
            "short_descriptions": ["Танцевальная вечеринка", "Ночной клуб", "Танцы до утра", "Музыкальная вечеринка"],
            "descriptions": [
        ...
        },
        {
            ...
            "short_descriptions": ["Встреча однокурсников", "Встреча друзей", "Воссоединение", "Встреча выпускников"],
            "descriptions": [
        ...
        },
        {
            ...
            "short_descriptions": ["Развиваем лидерские качества", "Личностный рост", "Саморазвитие", "Развитие навыков"],
            "descriptions": [
        ...
        },
        {
            ...
            "short_descriptions": ["Живая музыка", "Рок-музыка", "Концерт", "Музыкальное шоу"],
            "descriptions": [
        ...
        },
        {
            ...
            "short_descriptions": ["Гастрономический фестиваль", "Фестиваль еды", "Кулинарный фестиваль", "Фуд-фест"],
            "descriptions": [
        ...
        },
        {
            ...
            "short_descriptions": ["Пешеходная экскурсия", "Исторические места", "Обзорная экскурсия", "Познавательная прогулка"],
            "descriptions": [
        ...
        },
        {
            ...
            "short_descriptions": ["Финансовое планирование", "Инвестиции", "Финансы", "Управление капиталом"],
            "descriptions": [
        ...
        },
        {
            ...
            "short_descriptions": ["Многодневный тур", "Экскурсионный тур", "Туристический маршрут", "Путешествие"],
            "descriptions": [
